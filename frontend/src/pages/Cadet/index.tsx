...
import { CadetDashboardOverview } from "../../components/Cadet/CadetDashboardOverview";
import { ProfileSection } from "../../components/Cadet/ProfileSection";
import { AttendanceSection } from "../../components/Cadet/AttendanceSection";
import { LeaveSection } from "../../components/Cadet/LeaveSection";
import { TrainingSection } from "../../components/Cadet/TrainingSection";
import { ActivitiesSection } from "../../components/Cadet/ActivitiesSection";
import { CertificatesSection } from "../../components/Cadet/CertificatesSection";
import { AchievementsSection } from "../../components/Cadet/AchievementsSection";
import { StudyMaterialSection } from "../../components/Cadet/StudyMaterialSection";
import { SettingsSection } from "../../components/Cadet/SettingsSection";
import { 
  AlertCircle, 
  AlertTriangle,
  Award, 
    ...
    <div className="min-h-screen bg-slate-100 text-slate-900 flex flex-col font-sans antialiased">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto w-full">
          ...
          {activeTab === "materials" && (
            <StudyMaterialSection showToast={showToast} />
          )}
